    ...
    public static class DbInitializer
    {
        public static void Initialize(PmcAppDbContext context)
        {
            ...
            if (!context.Projects.Any())
            {
                ...
                {
                    new Project {Name="Project1", Uploaded= new DateTime(2020,1,1), DateCompleted=new DateTime(2016,1,1), Client="client1", Location=@"/pdf/project1.pdf", Success="Yes", Uploader_id=1},
                    new Project {Name="Project2", Uploaded= new DateTime(2020,1,1), DateCompleted=new DateTime(2018,1,1), Client="client1", Location=@"/pdf/project2.pdf", Success="No", Uploader_id=1 },
                    new Project {Name="Project3", Uploaded= new DateTime(2020,1,1), DateCompleted=new DateTime(2019,1,1), Client="client2", Location=@"/pdf/project3.pdf", Success="Yes", Uploader_id=2},
                };
